...
import { ArrowLeft, HardHat, CheckCircle2, Phone } from "lucide-react";
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-bold mb-4 glow-text">Plaster Works</h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Professional plastering services for smooth and durable wall finishes with attention to detail and quality.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <ServiceRequestForm serviceTitle="Plaster Works" />
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold mb-4 glow-text">Expert Plastering Services</h2>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Get professional plastering for smooth and durable wall finishes
          </p>
